##################################################
#  Praxis Universitaria - Particpación Ciudadana #
##################################################
...
# 3. Limpieza de protocolo y tokenización
...
# Crear lexicon de stopwords en español 
lexiconSW<-stopwords("es")

# Añadir al stopwords luego de mirar el reviwewords
...
title_word_pairs %>%
  ...
  ggtitle('Bigramas Protocolos Anecdoticos Globales') 