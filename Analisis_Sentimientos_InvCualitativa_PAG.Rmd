---
title: "Análisis de Sentimientos en Investigación: Praxis Universitaria y Particpación Ciudadana"
...
## 4. Carga y verificación del Protocolo
```{r,message=FALSE,warning=FALSE}
...
## 6.Sumar a los valores de la variable "positivo" los de la "negativo"
```{r,message=FALSE,warning=FALSE}
...
## 7.Graficar los resultados de la Cualificación del Sentimiento por página 
```{r,message=FALSE,warning=FALSE}
...
##8.Captar la curva de la línea por la que transita la narración
...
## 9.Graficar el resultado anterior como "Forma de la historia"
```{r,message=FALSE,warning=FALSE}
...
## 10.Obtener una gráfica sencilla de líneas con los mismos datos
```{r,message=FALSE,warning=FALSE}
